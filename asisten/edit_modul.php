...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $file_materi_existing = trim($_POST['file_materi_existing'] ?? '');
    $file_materi_path = $file_materi_existing;
        ...
        if (isset($_FILES['file_materi_baru']) && $_FILES['file_materi_baru']['error'] == 0) {
            ...
            if (!in_array($file_type, $allowed_types) || !in_array($file_ext, ['pdf', 'docx'])) {
                ...
                if (move_uploaded_file($file_tmp_name, $destination)) {
                    ...
                    $file_materi_path = 'uploads/materi_modul/' . $new_file_name;
                } else {
